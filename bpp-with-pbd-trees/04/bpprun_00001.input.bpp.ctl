...
*        speciestree = 1  0.4 0.2 0.1   * speciestree pSlider ExpandRatio ShrinkRatio
  ...
  species&tree = 20  S1.1 S1.13 S1.9 S1.2 S2.8 S1.5 S1.18 S1.7 S1.6 S1.16 S1.14 S1.3 S1.10 S1.15 S1.20 S1.12 S1.4 S1.11 S1.17 S1.19
                     2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2
                 (((S1.1,S1.13),S1.9),(((S1.2,S2.8),(((S1.5,S1.18),S1.7),((S1.6,S1.16),S1.14))),((S1.3,((S1.10,(S1.15,S1.20)),S1.12)),(S1.4,(S1.11,(S1.17,S1.19))))));
    ...
    thetaprior = 3.0 0.08   # invgamma(a, b) for theta, mean = 0.04
      tauprior = 3.0   0.0012542930357212674       # invgamma(a, b) for root tau & Dirichlet(a) for other tau's, mean = 0.0006271465178606337; root age (raw, unscaled) = 25.085860714425344
